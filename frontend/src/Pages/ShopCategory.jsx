...
//   // Cập nhật selectedCategory dựa trên URL hiện tại
//   useEffect(() => {
//     const path = location.pathname.split("/")[1]; // Lấy tên danh mục từ URL
//     setSelectedCategory(path || ""); // Cập nhật selectedCategory
//   }, [location.pathname]);
